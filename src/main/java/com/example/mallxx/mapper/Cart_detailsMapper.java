...
public interface Cart_detailsMapper {
    //用户操作
    @Insert("INSERT INTO cart_details(cart_details_id,cart_id,product_id,quantity,unit_price,creat_data,merchant_id)" +
            "values (#{cart_details.cart_details_id},#{cart_details.cart_id},#{cart_details.product_id},#{cart_details.quantity},#{cart_details.unit_price},#{cart_details.creat_data}),#{cart_details.merchant_id}")
